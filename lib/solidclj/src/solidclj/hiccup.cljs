...
(defn ?
  ...
  - A **reactive atom** (solidclj.satom/atom) — bridges it to a Solid
    signal and returns the current value directly. Equivalent to just
    deref'ing the s/atom inside a reactive thunk.
